...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%F{#737994}╭─'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%F{#737994}├─'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%F{#737994}╰─'
  ...
  typeset -g POWERLEVEL9K_RULER_FOREGROUND='#737994'
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND='#737994'
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#8caaee'
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#99d1db'
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%F{#737994}'     # default foreground
      local      clean='%F{#a6d189}'   # green foreground
      ...
      local       meta='%F{#737994}'  # grey foreground
      local      clean='%F{#737994}'  # grey foreground
      local   modified='%F{#737994}'  # grey foreground
      local  untracked='%F{#737994}'  # grey foreground
      local conflicted='%F{#737994}'  # grey foreground
    fi
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR='#a6d189'
  typeset -g POWERLEVEL9K_VCS_LOADING_VISUAL_IDENTIFIER_COLOR='#737994'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND='#a6d189'
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND='#a6d189'
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND='#e5c890'
